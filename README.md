...
One feature we added is the ability to create conversations with multiple back and forth Requests and Responses. This was done by simply passing through the context of the conversation into each continued interation of the conversation (although this was quite the hastle to do in the shortcuts app).  
